...
<section class="home-section">
    {{ Breadcrumbs::render('add_banner_promo') }}
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('banner-promo.store') }}" method="POST">
                    @csrf
                    <div class="card">
                            ...
                            <div class="row d-flex align-items-stretch">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <input id="input_banner_link" value="{{ old('banner_link') }}" name="banner_link" type="text" class="form-control @error('banner_link') is-invalid @enderror" placeholder="Write link here.." />
                                        @error('banner_link')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
