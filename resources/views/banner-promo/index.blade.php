...
<section class="home-section">
    {{ Breadcrumbs::render('banner_promos') }}
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ route('banner-promo.index') }}" method="GET">
                                    <div class="input-group">
                                        <input name="keyword" value="{{ request()->get('keyword') }}" type="search" class="form-control" style="height: 40px;" placeholder="Search for banner promo..">
                            ...
                            <div class="col-md-6">
                                @can('Banner Create')
                                <a href="{{ route('banner-promo.create') }}" class="btn btn-primary float-right" role="button">
                                    Add New
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 7%;" class="valign-middle tx-center">
                                                <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                                    ...
                                                    <div class="col-md-6">
                                                        @can('Banner Update')
                                                        <a href="{{ route('banner-promo.edit', ['banner_promo' => $banner]) }}" class="btn btn-sm btn-info" role="button">
                                                    ...
                                                    <div class="col-md-6">
                                                        @can('Banner Delete')
                                                        <form class="d-inline" role="alert" action="{{ route('banner-promo.destroy', ['banner_promo' => $banner]) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
    ...
    $(document).ready(function() {
        $("form[role='alert']").submit(function(event) {
            ...
            Swal.fire({
                ...
                text: 'Are you sure want to remove Banner Promo?',
                icon: 'warning',
