                            ...
                            <div class="row d-flex align-items-stretch">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <input id="input_banner_title" value="{{ old('banner_name', $banner->banner_name) }}" name="banner_name" type="text" class="form-control @error('banner_name') is-invalid @enderror" placeholder="" />
                                        @error('banner_name')
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <input id="input_banner_seq" value="{{ old('banner_seq', $banner->banner_seq) }}" name="banner_seq" type="number" class="form-control @error('banner_seq') is-invalid @enderror" placeholder="" />
                                        @error('banner_seq')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <input id="input_banner_slug" name="banner_slug" type="text" class="form-control @error('banner_slug') is-invalid @enderror" value="{{ old('banner_slug', $banner->banner_slug) }}" readonly />
                                        @error('banner_slug')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="input_banner_image" name="banner_image" value="{{ old('banner_image', $banner->banner_image) }}" type="text" class="form-control @error('banner_image') is-invalid @enderror" placeholder="" readonly />
                                            @error('banner_image')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group{{ $errors->has('is_active') ? ' has-error' : '' }} _form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="switch">
                                                <input type="checkbox" name="is_active" {{ old('is_active', $banner->is_active) == 1  ? 'checked'  : null }}>
