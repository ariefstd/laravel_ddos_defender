...
<section class="home-section">
    {{ Breadcrumbs::render('add_catalog') }}
                            ...
                            <div class="row d-flex align-items-stretch">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <input id="input_banner_title" value="{{ old('catalog_name') }}" name="catalog_name" type="text" class="form-control @error('catalog_name') is-invalid @enderror" placeholder="Write name here.." />
                                        @error('catalog_name')
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <input id="input_banner_seq" value="{{ old('catalog_seq') }}" name="catalog_seq" type="number" class="form-control @error('catalog_seq') is-invalid @enderror" placeholder="Only number, example: 1" />
                                        @error('catalog_seq')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <input id="input_banner_slug" value="{{ old('catalog_slug') }}" name="catalog_slug" type="text" class="form-control @error('catalog_slug') is-invalid @enderror" placeholder="Auto Generate" readonly />
                                        @error('catalog_slug')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="input_banner_image" name="catalog_file" value="{{ old('catalog_file') }}" type="text" class="form-control @error('catalog_file') is-invalid @enderror" placeholder="Choose file" readonly />
                                            @error('catalog_file')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
