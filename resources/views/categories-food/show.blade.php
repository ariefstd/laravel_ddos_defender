            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                @if (file_exists(public_path($categoriesFood->food_thumbnail)))
                                <div class="food-tumbnail" style="background-image: url('{{ asset($categoriesFood->food_thumbnail) }}');">
                                </div>
                                @else
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('categories-food.index') }}" class="btn btn-warning mx-1" role="button">
                                Back
                            </a>
                        </div>
                    </div>
