                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="{{ route('categories-post.create') }}" class="btn btn-primary float-right" role="button">
                                    Add New
                                            ...
                                            <td style="width: 7%;" class="valign-middle tx-center">
                                                <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <a href="{{ route('categories-post.edit', ['categories_post' => $category]) }}" class="btn btn-sm btn-info" role="button">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <form class="d-inline" role="alert" action="{{ route('categories-post.destroy', ['categories_post' => $category]) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
