...
<section class="home-section">
    {{ Breadcrumbs::render('detail_cat_team', $categoriesTeam) }}
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('categories-team.update', ['categories_team' => $categoriesTeam]) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="card">
                            ...
                            <div class="row d-flex align-items-stretch">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <input id="input_category_title" value="{{ old('category_name', $categoriesTeam->category_name) }}" name="category_name" type="text" class="form-control @error('category_name') is-invalid @enderror" placeholder="" />
                                        @error('category_name')
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <input id="input_category_slug" name="category_slug" type="text" class="form-control @error('category_slug') is-invalid @enderror" value="{{ old('category_slug', $categoriesTeam->category_slug) }}" readonly />
                                        @error('category_slug')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group{{ $errors->has('is_active') ? ' has-error' : '' }} _form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="switch">
                                                <input type="checkbox" name="is_active" {{ old('is_active', $categoriesTeam->is_active) == 1  ? 'checked'  : null }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="float-right">
                                        <a class="btn btn-outline-secondary _btn-secondary px-4" href="{{ route('categories-team.index') }}">Back</a>
