...
<section class="home-section">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('flash-news.update', ['flash_news' => $flashNews]) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="card">
                            ...
                            <div class="row d-flex align-items-stretch">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <textarea id="input_banner_title" value="" name="news_name" type="text" class="form-control @error('news_name') is-invalid @enderror" placeholder="" rows="3">{{ old('news_name', $flashNews->news_name) }}</textarea>
                                        @error('news_name')
                                    ...
                                    <div class="form-group _form-group">
                                        ...
                                        <input id="input_banner_slug" name="news_slug" type="text" class="form-control @error('news_slug') is-invalid @enderror" value="{{ old('news_slug', $flashNews->news_slug) }}" readonly />
                                        @error('news_slug')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group{{ $errors->has('is_active') ? ' has-error' : '' }} _form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="switch">
                                                <input type="checkbox" name="is_active" {{ old('is_active', $flashNews->is_active) == 1  ? 'checked'  : null }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="float-right">
                                        ...
                                        <button type="submit" class="btn btn-primary _btn-secondary px-4">
                                            Update
                                        </button>
                                    </div>
                                </div>
