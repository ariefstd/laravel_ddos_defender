            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        {{-- FILTER:start --}}
                        <form action="{{ route('stall.index') }}" method="GET" class="row">
                            <div class="col-2">
                            ...
                            <div class="col-2">
                                ...
                                <a href="{{ route('stall.index') }}" class="btn btn-info">Reset</a>
                            </div>

                            <div class="col-md-2">
                                @can('Stall Create')
                                <a href="{{ route('stall.create') }}" class="btn btn-primary float-right" role="button">
                                    Add New
                                </a>
                                @endcan
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 21%;" class="tx-center valign-middle tx-medium tx-inverse tx-14">
                                                {{ $stall->market->market_name }}
                                            </td>

                                            <td style="width: 10%;" class=" tx-center valign-middle tx-medium tx-inverse tx-14">
                                                {{ $stall->city->city_name }}
                                            </td>

                                            <td style="width: 10%;" class=" tx-center valign-middle tx-medium tx-inverse tx-14">
                                                {{ $stall->region->region_name }}
                                            </td>



                                            <td style="width: 10%;" class=" valign-middle tx-center">@if ($stall->is_active == 1)
                                            ...
                                            <td style="width: 7%;" class="valign-middle tx-center">
                                                <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                                    <!-- <div class="col-md-4">
                                                        <a href="{{ route('stall.show', ['stall' => $stall]) }}" class="btn btn-sm btn-primary" role="button">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                    </div> -->
                                                    <div class="col-md-6">
                                                        @can('Stall Update')
                                                        <a href="{{ route('stall.edit', ['stall' => $stall]) }}" class="btn btn-sm btn-info" role="button">
                                                    ...
                                                    <div class="col-md-6">
                                                        @can('Stall Delete')
                                                        <form class="d-inline" role="alert" action="{{ route('stall.destroy', ['stall' => $stall]) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                        ...
                                        <p style="text-align: center; padding-top: 50px;">
                                            ...
                                            <strong>Stall not found</strong>

                                            @else
                                            <strong>No Stall data yet</strong>
                                            @endif
...
<script>
    $(document).ready(function() {
        $("form[role='alert']").submit(function(event) {
            ...
            Swal.fire({
                title: 'Delete Kios',
                text: 'Are you sure want to remove Kios?',
                icon: 'warning',
