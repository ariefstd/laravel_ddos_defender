                            ...
                            <div class="col-md-6">
                                <form action="{{ route('tags.index') }}" method="GET">
                                    <div class="input-group">
                                        <input name="keyword" value="{{ request()->get('keyword') }}" type="search" class="form-control" style="height: 40px;" placeholder="Search for tag..">
                                ...
                                <table class="table mg-b-0 tx-13">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 10%;" class=" valign-middle tx-center">@if ($tag->is_active == 1)
                                            ...
                                            <td style="width: 7%;" class="valign-middle tx-center">
                                                <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                                    <!-- <div class="col-md-4">
                                                        <a href="{{ route('tags.show', ['tag' => $tag]) }}" class="btn btn-sm btn-primary" role="button">
                                        ...
                                        <p style="text-align: center; padding-top: 50px;">
                                            ...
                                            <strong>Tag not found</strong>

                                            @else
                                            <strong>No Tag data yet</strong>
                                            @endif
